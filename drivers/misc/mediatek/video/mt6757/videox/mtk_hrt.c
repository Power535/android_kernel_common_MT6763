...
{
	int ext_layer_num_on_OVL = 0, ext_layer_num_on_OVL_2L = 0;
	int phy_layer_num_on_OVL = 0, phy_layer_num_on_OVL_2L = 0;
	int hw_layer_num = 0;	/* tmp variable */
	int is_on_OVL = 0, is_ext_layer = 0;
	int disp_idx = 0, i = 0;
	struct layer_config *src_info = NULL, *dst_info = NULL;
	int layout_layers = 0, prim_layout_layers = 0;
